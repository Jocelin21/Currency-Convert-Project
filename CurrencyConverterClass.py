...
class CurrencyConvert:
    ...
    def __init__(self, tk):
        ...
        self.currencyOpt1 = OptionMenu(tk, self.variable1, *currency_list)
        ...
        self.money_converted = Label(tk, text="", textvariable=self.total)
        self.money_converted.config(fg='#282828', font=('Helvetica', 12))
        self.money_converted.pack(pady=2)

        # From-To labels
        self.from_label = Label(tk, text="From", fg='#282828', font=('Helvetica', 12)).place(x=40, y=10)
        self.to_label = Label(tk, text="To", fg='#282828', font=('Helvetica', 12)).place(x=40, y=80)
        self.total_label = Label(tk, text="Total:", fg='#282828', font=('Helvetica', 12)).place(x=40, y=155)
